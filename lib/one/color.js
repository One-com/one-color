        ...
        if (obj.charCodeAt) {
            ...
            if (matchCssSyntax) {
                ...
                return new one.color[colorSpaceName](
                    parseFloat(matchCssSyntax[2]) / (matchCssSyntax[3] ? 100 : (colorSpaceName[0] === 'H' ? 360 : 255)),
                    parseFloat(matchCssSyntax[4]) / (matchCssSyntax[5] || colorSpaceName[0] === 'H' ? 100 : 255),
                    parseFloat(matchCssSyntax[6]) / (matchCssSyntax[7] || colorSpaceName[0] === 'H' ? 100 : 255),
