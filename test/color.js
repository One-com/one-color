      ...
      describe(colorSpace.name, function () {
        ...
        var clr =
          colorSpace.name === 'CMYK'
            ? new color[spaceName](1, 1, 1, 1, 1)
            : new color[spaceName](0, 0, 0, 1);
        ...
        describe('color space conversion', function () {
          spaces.forEach(function (otherSpace) {
            it(
              'should have a ' + otherSpace.name + ' conversion method',
              function () {
                var expected = {};
            ...
            it('should convert to ' + otherSpace.name, function () {
              ...
              expect(
                clr[otherSpace.name.toLowerCase()](),
                'to satisfy',
                expected
              );
          ...
          spaces.forEach(function (otherSpace) {
            it('should equal same color in ' + otherSpace.name, function () {
              if (otherSpace.name === 'CMYK') {
                expect(
                  clr.equals(new color[otherSpace.name](1, 1, 1, 1, 1)),
                  'to be true'
                );
              } else {
                expect(
                  clr.equals(new color[otherSpace.name](0, 0, 0, 1)),
                  'to be true'
                );
              }
            });
        ...
        it('should convert to JSON', function () {
          var clr = new color[colorSpace.name](
            Math.random(),
            Math.random(),
            Math.random(),
            Math.random(),
        ...
        describe('color channels', function () {
          colorSpace.channels.forEach(function (channel) {
            ...
            describe(channel, function () {
              ...
              it(
                'should have a "' + shortHand + '" shorthand method',
                function () {
                  var expected = {};

                  expected[shortHand] = expect
                    .it('to be a function')
                    .and('to have arity', 2);
              ...
              it('should get the "' + channel + '" value', function () {
                expect(
                  new color[colorSpace.name](0, 0, 0, 0, 0)[channel](),
                  'to be',
                  0
                );
              });
              ...
              it('should adjust the "' + channel + '" value', function () {
                expect(
                  clr[channel](0)[channel](0.5, true)[channel](),
                  'to be',
                  0.5
                );
              });
              ...
              it(
                ...
                function () {
                  expect(
                    clr[channel](0)[shortHand](0.5, true)[channel](),
                    'to be',
                    0.5
                  );
                }
